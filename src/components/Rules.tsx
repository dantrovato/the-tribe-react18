  ...
  return (
    <div className="m-5 text-muted">
      ...
      <p>
        ...
        surely, somebody will start playing and more and more people will then
        join in, separately or otherwise. Remember that there is never any
        pressure to join in and if you're uncomfortable at any point, do speak
        to anyone wearing a flashing blue armband. The 'generals' are there to
